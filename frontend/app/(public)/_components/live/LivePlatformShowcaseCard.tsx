    ...
    <Card className="flex h-full w-full flex-col">
      <CardBody className="flex flex-1 flex-col gap-fefe-3">
        ...
        <Link
          ...
          className="mt-auto inline-flex items-center gap-1 font-fefe text-sm font-medium text-fefe-gold transition-colors hover:text-fefe-gold-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fefe-gold focus-visible:ring-offset-2 focus-visible:ring-offset-fefe-cream"
        >
          {copy.ctaLabel}
