    ...
    return (
      <AdminPageContainer>
        <WorkspaceInlineError
          ...
          message="Open this page from Vendors and try again."
        />
      </AdminPageContainer>
    );
  }
    ...
    <AdminWorkspacePageLayout
      ...
      intro={
        <AdminPageIntro
          ...
          subtitle="Shows currently contributing to this vendor balance."
          breadcrumb={
          ...
          action={
            <Link
              href={vendorDetailPaymentHref(id)}
