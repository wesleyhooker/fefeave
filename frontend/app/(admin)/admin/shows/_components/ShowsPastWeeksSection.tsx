  ...
  return (
    <section aria-labelledby="shows-past-weeks-heading">
      <div className="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-workspace-surface">
        ...
        <div className={`p-2.5 sm:p-4 ${workspaceMutedStrip}`}>
            ...
            {pastBlocks.map((block) => (
              <li key={block.startStr}>
                <details className="group overflow-hidden rounded-xl border border-gray-200/95 bg-white shadow-sm transition-[box-shadow,ring] duration-200 ease-out motion-reduce:transition-none open:shadow-md open:ring-1 open:ring-gray-300/45">
                  <summary
                    className={`flex cursor-pointer list-none items-center gap-3 border-l-[3px] border-l-gray-500/45 bg-gray-50/90 px-3.5 py-3.5 outline-none [&_*]:cursor-inherit sm:min-h-0 sm:px-4 sm:py-3.5 ${workspaceTableRowInteractive} touch-manipulation hover:bg-gray-100/95 focus-visible:ring-2 focus-visible:ring-gray-400 focus-visible:ring-offset-2 group-open:border-b group-open:border-gray-200/90 group-open:bg-white [&::-webkit-details-marker]:hidden`}
                  ...
                  <div className="border-t border-gray-200/95 bg-gradient-to-b from-gray-50/95 to-[#F3F4F6]/80 px-2.5 py-2.5 transition-[opacity,transform] duration-200 ease-out motion-reduce:transition-none motion-reduce:transform-none group-open:opacity-100 group-open:translate-y-0 opacity-95 -translate-y-0.5 sm:p-3.5">
