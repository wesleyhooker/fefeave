...
cd "$BACKEND_DIR"
set +e
DATABASE_URL="$DATABASE_URL" npx jest --runInBand --testPathPattern="(db-smoke|shows-integration|wholesalers-integration|owed-line-items-integration|settlement-ledger-integration|show-settlement-patch-integration|vendor-expense-ledger-integration|closed-show-freeze-integration|inventory-purchases-integration|business-expenses-integration|financial-strategy-integration|cash-snapshots-integration|financial-recommendations-integration|financial-events-integration|financial-events-dual-write-integration|financial-events-backfill-integration|event-derived-cash-parity-integration|financial-activity-integration|financial-activity-vendor-filter-integration|financial-event-summaries-integration|financial-obligation-projections-integration|wholesaler-balance-snapshots-integration|financial-show-profit-integration|financial-statement-projections-integration|owner-weekly-payout-integration|owner-self-pay-activity-integration|strategy-allocation-integration|wholesaler-payment-correction-integration|vendor-payment-write-trust-integration|payment-drift-reconcile-integration|notifications-integration|notifications-api-integration|portal-integration|exports-balances-csv)"
EXIT_CODE=$?
set -e
